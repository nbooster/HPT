...
4. Super easy usage (just add: HPT::Timer T("Code Block Name"); at the start of any code block anywhere, and HPT::PrintResults(); to print the results).
5. Super light (negligible overhead of time and space).
